...
class Tour {
    ...
    /**
     * @var MarkdownFile|null tour.md file, never modified
     */
    private $file;
    /**
     * @var array [$id => View, ...] for all view modules in the tour
     */
    private $views;

    /**
     * @var string|null Unique tour identifier generated by plugin on initial tour save, set in constructor, should not be modified
     */
    private $id;
    /**
     * @var string|null
    ...
    private $title;
    /**
     * @var array [id => [id, include_all, add_all], ...], List of datasets included in the tour, indexed for convenience
     */
    private $datasets;
    /**
     * @var array id => [popup props, attribution, legend, icon/path]
     */
    private $dataset_overrides;
    /**
     * @var array [id => [id, popup_content, remove_popup]], indexed for convenience
     */
    private $features;
    /**
     * @var string|null
    ...
    private $attribution;
    /**
     * @var array [include, toggles, basemaps]
     */
    private $legend;
    /**
     * @var array [select, provider, url, attribution, key, id]
     */
    private $tile_server;
    /**
     * @var array|null Array of file names
     */
    private $basemaps;
    /**
     * @var array [location, lng, lat, distance, bounds]
     */
    private $start;
    /**
     * @var array [wide_column, map_on_right, show_map_location_in_url]
     */
    private $overrides;
    /**
     * @var array [remove_tile_server, only_show_view_features, list_popup_buttons]
     */
    ...
    /**
     * @var array|null [$id => Feature] for features from all datasets in the tour - set when needed, cleared with features when tour or datasets change
     */
    private $all_features;
    /**
     * @var array|null list of feature ids for all included features in tour (from datasets with include_all and not hidden or included in tour features list) - set when needed, cleared with features when tour or datasets change
     */
    private $included_features;
    /**
     * @var array|null list of all features in the tour, features have modifications from tour options
     */
    private $merged_features;
    /**
     * @var array|null list of dataset ids of all datasets with at least one feature included in tour - cleared when features are cleared, generated when included_features is generated
     */
    private $included_datasets;
    /**
     * @var array|null [$id => Dataset] for all datasets in tour with at least one included feature] - set when needed, cleared with features when tour or datasets change
     */
    private $merged_datasets;
    /**
     * @var array|null ['url' => string] + options or ['provider' => string] + options - set when needed, cleared when plugin/config or tour changes
     */
    private $tile_server_options;
    /**
     * @var array|null [$id => array from plugin config basemap_info] for all basemaps in tour and views combined - set when needed, cleared when plugin/config, tour, or views change
     */
    private $basemap_info;
